# genpark-agentic-data-pipeline-observability-schema-drift-monitor-skill
...
> **GenPark AI Agent Skill** -- Agentic data pipeline observability engine detecting schema drift and null rate spikes (Monte Carlo style)
